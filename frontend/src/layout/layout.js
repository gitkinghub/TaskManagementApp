...
function Layout({ children }) {
  ...
  useEffect(() => {
    if (!token) {
      ...
      console.warn(
        "No authentication token found. Some features may be limited."
      );
    }
  }, [token, navigate]);
      ...
      <div className="row flex-nowrap overflow-auto">
        <div
          className={
            ...
            " col-auto col-md-1 px-0 bg-default border-right min-vh-100 trans"
          }
        >
          <div className={"logo"}>
            {!open && (
                ...
                <ul className="navbar-nav ms-auto align-items-center d-lg-none">
                  <li className="nav-item px-2">
                    ...
                    >
                      <img
                        src={Profile}
                        className="rounded-circle user-profile mr-2"
                      />
                    </a>
                  </li>
                </ul>
